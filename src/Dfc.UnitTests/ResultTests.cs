...
namespace Dfc.UnitTests
{
    public class ResultTests
    {
        ...
        public async Task CalcuateResult_WithSession_ShouldHaveResultsData()
        {
            ...
            var AssessmentCalculationService = new AssessmentCalculationService(_jobFamilyRepository, _shortTraitRepository);
        ...
        public void CalculateJobFamilyRelevance_WithRobExample_ShouldBeAsResult()
        {
            ...
            var result = AssessmentCalculationService.CalculateJobFamilyRelevance(ResultTestMockData.JobFamilies, userTraits, "en");
