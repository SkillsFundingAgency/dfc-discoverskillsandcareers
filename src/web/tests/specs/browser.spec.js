describe('National Careers Service', () => {
  ...
  it('Run through short assessment and get result', () => {
    ...
    browser.driver.get('https://dfcdevskillscareersstr.z6.web.core.windows.net/')
      ...
      .then(() => browser.driver.wait(EC.presenceOf(element(by.id('selected_answer-3'))), 10000))
      ...
      .then(() => browser.driver.wait(EC.presenceOf(element(by.id('selected_answer-1'))), 10000))
      ...
      .then(() => browser.driver.wait(EC.presenceOf(element(by.className('app-button--outline'))), 10000))
      ...
      .then(() => browser.driver.wait(EC.presenceOf(element(by.id('selected_answer-4'))), 10000))
  ...
  it('Start short assessment, get session ID and check if it resumes assessment', () => {
    browser.driver.getCapabilities()
      .then((caps) => {
        const currentOS = caps.map_.get('platformName')? caps.map_.get('platformName') : caps.map_.get('platform')
