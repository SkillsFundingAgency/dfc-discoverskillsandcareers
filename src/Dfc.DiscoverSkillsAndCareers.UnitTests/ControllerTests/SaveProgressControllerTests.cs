...
namespace Dfc.UnitTests.ControllerTests
{
    ...
    {
        private readonly ILogger<SaveProgressController> _logger;
        private readonly IApiServices _apiServices;
        private readonly SaveProgressController _controller;
        ...
        public SaveProgressControllerTests()
        {
            ...
            _controller = new SaveProgressController(_logger, _apiServices, _appSettings, _dataProtectionProvider, _layoutService)
            {
                TempData = _tempData,
        ...
        public async Task Index_ShouldReturn_500OnError()
        {
            ...
            var controller = Substitute.ForPartsOf<SaveProgressController>(new object[] { _logger, _apiServices, _appSettings, _dataProtectionProvider, _layoutService });
